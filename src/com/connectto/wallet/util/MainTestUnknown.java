...
public class MainTestUnknown {
    ...
    public static void main(String[] args) throws InvalidParameterException, InternalErrorException, PermissionDeniedException, UnsupportedCurrencyException {
        ...
        TransactionSendMoney unknown = TransactionSendMoneyDemo.initDemoTransactionSendMoney(56 * 100d, CurrencyType.RUB, CurrencyType.AMD, CurrencyType.USD, CurrencyType.USD);
