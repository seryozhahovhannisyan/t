 ...
 */
public class MerchantTransferDemo {

    public static MerchantTransferTransaction initTransaction(ExchangeRate selectedExchangeRate,
    ...
    private static MerchantTransferTransaction createTransaction(ExchangeRate selectedExchangeRate, Double transferAmount, CurrencyType transferCurrencyType, Wallet wallet, WalletSetup walletSetup ) throws PermissionDeniedException, InvalidParameterException, InternalErrorException {
        ...
        MerchantTransferTransaction transaction = new MerchantTransferTransaction();
