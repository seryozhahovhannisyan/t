 ...
 */
public class TransactionRequestProcessTax {
    ...
    public TransactionRequestProcessTax() {
    }

    public TransactionRequestProcessTax(Long walletId, Long setupId,
    ...
    public TransactionRequestProcessTax(Long walletId, Long setupId, Double processTax, CurrencyType processTaxCurrencyType, Double processTaxPrice, CurrencyType processTaxPriceCurrencyType, TransactionTaxType processTaxType, TransactionRequestExchange exchange) {
        this.walletId = walletId;
        this.setupId = setupId;
