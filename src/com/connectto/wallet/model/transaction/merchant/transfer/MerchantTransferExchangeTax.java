 ...
 */
public class MerchantTransferExchangeTax {
    ...
    public MerchantTransferExchangeTax() {
    }

    public MerchantTransferExchangeTax(Date actionDate, Long walletId, Long setupId,
