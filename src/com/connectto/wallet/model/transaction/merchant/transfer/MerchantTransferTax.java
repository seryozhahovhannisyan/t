 ...
 */
public class MerchantTransferTax {
    ...
    public MerchantTransferTax() {
    }

    public MerchantTransferTax(Date actionDate, Long walletId, Long setupId ) {
    ...
    public MerchantTransferTax(Date actionDate, Long walletId, Long setupId, MerchantTransferExchangeTax exchangeTax) {
        this.actionDate = actionDate;
        this.walletId = walletId;
        this.setupId = setupId; 
