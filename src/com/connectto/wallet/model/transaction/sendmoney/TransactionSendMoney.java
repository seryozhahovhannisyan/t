 ...
 */
public class TransactionSendMoney {
    ...
    //total tax from + to
    private TransactionSendMoneyTax tax;
    //attached files
    private List<TransactionData> transactionDatas;

    private TransactionSendMoneyProcess fromTransactionProcess;
    private TransactionSendMoneyProcess toTransactionProcess;
    ...
    public void createTax() {
        this.tax = new TransactionSendMoneyTax( walletSetupId,
    ...
    public TransactionSendMoneyTax getTax() {
        return tax;
    }

    public void setTax(TransactionSendMoneyTax tax) {
        this.tax = tax;
    }
    ...
    public TransactionSendMoneyProcess getFromTransactionProcess() {
        return fromTransactionProcess;
    }

    public void setFromTransactionProcess(TransactionSendMoneyProcess fromTransactionProcess) {
        this.fromTransactionProcess = fromTransactionProcess;
    }

    public TransactionSendMoneyProcess getToTransactionProcess() {
        return toTransactionProcess;
    }

    public void setToTransactionProcess(TransactionSendMoneyProcess toTransactionProcess) {
